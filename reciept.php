...
<?php
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="bs" id="bs" value="<?php echo $row["basic_salary"]; ?>" readonly></td>
                        <td><input type="text" name="bo" id="bo" value="<?php echo $row["bonus"]; ?>"readonly></td>
                        <td><input type="text" name="sp"  id="sp" value="<?php echo $row["Special_allowance"]; ?>" readonly></td>
                        <td><input type="text" name="rent" id="rent" value="<?php echo $row["rent_allowance"]; ?>" readonly></td>

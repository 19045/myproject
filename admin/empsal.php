...
<?php
                ...
                { ?>
                    ...
                    <tr>
                        ...
                        <?php $idd=$_SESSION['uid']=$row['id']; ?>

                        <?php if($row["status"]==1)
                            {
                                ?>
                            <td><label for="css">NOT Updated!</label></td>
                            <?php 
                            }
                        else
                            {
                                ?>
                            <td><label for="css">Updated!</label></td>
                            <?php } 
                            ?>

                        <?php if($row["status"]==1)
                        {?>
                        <td> <a href="empsal3.php?pid=<?php echo $row['id']; ?>">Update</a></td>
                        <?php }
                        else
                        {?>
                        <td> <a href="empsal3.php?pid=<?php echo $row['id']; ?>">Make Change</a></td>
                        <?php } ?>
